...
toc_footers:
  - <a href='https://phinix.ir/login'>عضویت در فینیکس</a>
...
وب‌سرویس‌های فینیکس به صورت REST در اختیار کاربران قرار گرفته است.
...
```shell
curl --location --request POST 'https://api.phinix.ir/auth/login' \
...
fetch("https://api.phinix.ir/auth/login", requestOptions)
...
$request->setUrl('https://api.phinix.ir/auth/login');
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/currencies/stats' \
--data-raw ''
```
...
fetch("https://api.phinix.ir/v1/currencies/stats", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/currencies/stats');
$request->setMethod(HTTP_Request2::METHOD_GET);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
<aside class="info">
برای مشاهده توضیحات درباره market Symbol های فینیکس میتوانید به درخواست لیست بازار ها مراجعه کنید
</aside>
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/trades?symbol=BTCTMN' \
--data-raw ''
```
...
fetch("https://api.phinix.ir/v1/trades?symbol=BTCTMN", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/trades?symbol=BTCTMN');
$request->setMethod(HTTP_Request2::METHOD_GET);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
`GET https://api.phinix.ir/v1/trades`
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/account/profile' \
...
fetch("https://api.phinix.ir/v1/account/profile", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/account/profile');
$request->setMethod(HTTP_Request2::METHOD_GET);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
```shell
curl --location --request POST 'https://api.phinix.ir/v1/account/card-numbers' \
--header 'Authorization: Bearer your-token' \
--header 'Content-Type: application/json' \
--data-raw '{
    "card_number":"6037991895454444"
...
`POST https://api.phinix.ir/v1/account/card-numbers`
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/account/ibans' \
--header 'Authorization: Bearer your-token' \
--data-raw ''
```
...
```shell
curl --location -g --request DELETE 'https://api.phinix.ir/v1/account/ibans/{ibanID}' \
--header 'Authorization: Bearer your-token' \
--data-raw ''
```
...
fetch("https://api.phinix.ir/v1/account/ibans/{ibanID}", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/account/ibans/{ibanID}');
$request->setMethod(HTTP_Request2::METHOD_DELETE);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
`DELETE https://api.phinix.ir/v1/account/ibans/{ibanID}`
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/account/balances' \
--header 'Authorization: Bearer your-token' \
--data-raw ''
```
...
fetch("https://api.phinix.ir/v1/account/balances", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/account/balances');
$request->setMethod(HTTP_Request2::METHOD_GET);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
```shell
curl --location --request POST 'https://api.phinix.ir/v1/account/orders' \
--header 'Authorization: Bearer your-token' \
--header 'Content-Type: application/json' \
--data-raw '{
    "price":"24828",
...
fetch("https://api.phinix.ir/v1/account/orders", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/account/orders');
$request->setMethod(HTTP_Request2::METHOD_POST);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
`DELETE https://api.phinix.ir/v1/account/orders`
...
```shell
curl --location --request GET 'https://api.phinix.ir/v1/account/trades?symbol=USDTTMN&side=sell&active=false' \
--header 'Authorization: Bearer your-token' \
--data-raw ''
```
...
fetch("https://api.phinix.ir/v1/account/trades?symbol=USDTTMN&side=sell&active=false", requestOptions)
  .then(response => response.text())
  .then(result => console.log(result))
  .catch(error => console.log('error', error));
```
...
require_once 'HTTP/Request2.php';
$request = new HTTP_Request2();
$request->setUrl('https://api.phinix.ir/v1/account/trades?symbol=USDTTMN&side=sell&active=false');
$request->setMethod(HTTP_Request2::METHOD_GET);
$request->setConfig(array(
  'follow_redirects' => TRUE
));
...
`GET https://api.phinix.ir/v1/account/trades`
